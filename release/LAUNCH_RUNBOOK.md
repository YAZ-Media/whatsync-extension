...
Reload the extension from the main folder to use v1.5.6, then refresh WhatsApp Web. Lovable Cloud function deployments still target the wrong database and are not the deployment path for backend changes.
