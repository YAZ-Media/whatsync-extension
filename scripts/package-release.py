...
for src,dest in [(website/'test-results/results.json','browser-tests.json'),(Path('/tmp/whatsync-final-audit.json'),'dependency-audit.json'),(Path('/tmp/whatsync-production-probe.json'),'production-readonly-probe.json'),(Path('/tmp/whatsync-production-acceptance.json'),'production-deployed-checks.json'),(Path('/tmp/whatsync-database-acceptance.json'),'database-deployed-checks.json'),(Path('/tmp/whatsync-node-tests.txt'),'node-tests.txt'),(Path('/tmp/whatsync-billing-tests.txt'),'billing-tests.txt'),(Path('/tmp/whatsync-postgres-tests.txt'),'postgres-tests.txt'),(Path('/tmp/whatsync-compiled-tests.json'),'compiled-site-tests.json')]:
